    ...
    <div class="dash-content">
        <div class="overview">
            <div class="title">
                ...
                <span class="text">Data Sampah Organik {{ $organik->kelurahan->name_kel}}</span>
            </div>
        </div>
        <div class="btn-cetak2">
            <a href="{{ route('cetak-1data-organik') }}" target="_blank" class="button-cetak">
                <i class="uil uil-print"></i>
                <span class="link-name">Cetak Data Organik</span>
            </a>
        </div>
    </div>
    @foreach ($organik as $organik )
                ...
                <div class="card-body">
                    ...
                    <table class="view2">
                        <tr>
                            ...
                            <td colspan="3">{{ $organik->larva_terima }}</td>
                        </tr>
                        <tr>
                            <td>Bak Beton</td>
                            <td>{{ $organik->tong }}</td>
                        ...
                        <tr>
                            <td>Pemanfaatan</td>
                            <td colspan="3">{{ $organik->pemanfaatan }}</td>
                        </tr>
                        <tr>
                            <td>Yang Mengelola</td>
                            <td colspan="3">{{ $organik->mengelolah }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">{{ $organik->timbangan }}</td>
                        </tr>
                        <tr>
                            <td>Jenis Pencatatan</td>
                            <td colspan="3">{{ $organik->jcatat }}</td>
                        </tr>
                        <tr>
                            <td>Dibangun Oleh</td>
                            <td colspan="3">{{ $organik->dbangun }}</td>
                        </tr>
                        <tr>
                            <td>Luas Bangunan</td>
                            <td colspan="3">{{ $organik->lbangunan }}</td>
                        </tr>
                        <tr>
                            <td>Daerah Cakupan</td>
                            <td colspan="3">{{ $organik->dcakup }}</td>
                        </tr>
                        <tr>
                            <td>Mesin Pencacah</td>
                            <td colspan="3">{{ $organik->mpencacah }}</td>
                        </tr>
                        <tr>
                            <td>Alat Angkut</td>
                            <td colspan="3">{{ $organik->a_angkut }}</td>
                        </tr>
                        <tr>
                            <td>Motor</td>
                            <td colspan="3">{{ $organik->motor }}</td>
                        </tr>
                        <tr>
                            <td>Gerobak Motor</td>
                            <td colspan="3">{{ $organik->gmotor }}</td>
                        </tr>
                        <tr>
                            <td>Pick Up</td>
                            <td colspan="3">{{ $organik->pickup }}</td>
                        </tr>
                        <tr>
                            <td>Truck</td>
                            <td colspan="3">{{ $organik->truck }}</td>
                        </tr>
                        <tr>
                            <td>Lainnya</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">{{ $organik->jml_alat }}</td>
                        </tr>
                    </table>
                </div>
            </article>
